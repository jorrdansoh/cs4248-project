# do cv with # NO CROSS VALIDATION
...
from sklearn.metrics import f1_score, confusion_matrix, pair_confusion_matrix, cohen_kappa_score, matthews_corrcoef, multilabel_confusion_matrix
import time
...
model = ImbPipeline(
    steps=[
        ...
        ("classifier", MLPClassifier(random_state=26, verbose=True)),
    ],
    verbose=True,
)
param_grid = {
    "classifier__hidden_layer_sizes": [(150, 100, 50), (120, 80, 40), (100, 50, 30), (80, 40, 20), (50, 30, 10)],
